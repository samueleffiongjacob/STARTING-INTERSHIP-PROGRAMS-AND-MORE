...
const Contact = () => {
  ...
  // SEND EMAIL FUNCTIONS FOR CLIENT
  const sendEmail = (e) => {
    e.preventDefault();
      ...
      .then(
        (result) => {
          ...
          toast({
            title: "Message Sent.",
            description:
              "We've received your message, we will surely get to you.",
            status: "success",
            duration: 5000,
            isClosable: true,
          });
  ...
  return (
    <>
      ...
      <Flex
        ...
        flexDir={"column"}
        zIndex="10"
        bgColor={message ? "#020a12bc" : "white"}
      >
        ...
        >
          ...
          >
            ...
            <Flex flexDir={"column"}>
              ...
              <Text>
                Block 23 Kaduna Close ND Western NPDC Estate Edjeba Warri
              </Text>
            </Flex>
          </Flex>
        </Flex>
        ...
        {message ? (
          ...
          >
            ...
            >
              ...
              {/** PASSING IN THE httpsSubmitForm FUNCTION FOR BACKEND to store information and  send transactional Email to CLIENT and ower for BACKEND ..... for frontend sendEmail FUNCTION with emailjs both are working */}
              <form
                ref={form}
                onSubmit={(e) => {
                  httpsSubmitForm(e);
              ...
              >
                ...
                >
                  ...
                  {messageRes && (
                    <p
                      bgColor={messageRes ? "#138E13" : "#08E608"}
                      color="white"
                      w={["330px", "400px", "450px"]}
                      h="50px"
                      justifyItems={"center"}
                  ...
                  {/*ERROR RESPONSE errorRes*/}
                  {errorRes && (
                    <p
                      bgColor={errorRes ? "#FF1F3E" : "#D20621"}
                      color="white"
                      w={["330px", "400px", "450px"]}
                      h="50px"
                      justifyItems={"center"}
                  ...
                  <Input
                    // id and value upadate for backend
                    id="fullname"
                ...
                >
                  ...
                  <Input
                    // id and email upadate for backend
                    id="email"
                ...
                >
                  ...
                  <Textarea
                    // id and message upadate for backend
                    id="message"
        ...
        {/* subscribe functionability BY THE BACKEND ENGINEER as created by frontend engineer  old(sendEmail) */}
        <Flex
          px={["15px", "2rem", "2rem", "2rem", "5rem"]}
          ...
          >
            <Flex flexDir="column" gap={[5, 6, 10, 10, 10]}>
              ...
              <Text
                ...
                pr={[-0, 1, 0]}
              >
                Want to be notified about our News? Just sign up and we will
            ...
            <Flex>
              <Flex
                ...
                mb={10}
              >
                {/* PASSING IN THE httpsSubcribeEmail FUNCTION FOR BACKEND to store information and send transactional Email to CLIENT and ower for BACKEND ..... for frontend sendEmail FUNCTION with emailjs both are working*/}
                <form
                  ref={form}
                  onSubmit={(e) => {
                    httpsSubcribeEmail(e);
                    sendEmail(e);
                  }}
                >
                  <Flex flexDir={["column", "column", "column", "row", "row"]}>
                    ...
                    {subcriberRes && (
                      <p
                        bgColor={subcriberRes ? "#138E13" : "#08E608"}
                        color="white"
                        focusBorderColor="none"
                        w={["350px", "480px", "350px", "400px", "400px"]}
                        borderRightRadius={[
                          "5px",
                          "5px",
                          "5px",
                    ...
                    {errorResSub && (
                      <p
                        bgColor={errorResSub ? "#FF1F3E" : "#D20621"}
                        color="white"
                        focusBorderColor="none"
                        w={["350px", "480px", "350px", "400px", "400px"]}
                        borderRightRadius={[
                    ...
                    <Input
                      // id and value upadate for emailsubcriber in the backend
                      id="email"
                      value={SUBCRIBERS}
                      onChange={({ target }) => setsubcriber(target?.value)}
                      required
                    ...
                    <Button
                      type="submit"
                      w={["350px", "200px", "140px", "130px", "150px"]}
                      h={["50px", "52px", "58px", "58px", "65px"]}
                      borderLeftRadius={["5px", "5px", "5px", "none", "none"]}
                      color="white"
                      // ml={"-3px"}
